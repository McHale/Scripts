...
while timer>getticks() do
    if UO.ContSizeX..UO.ContSizeY==gump[2].x..gump[2].y
        and UO.GetPix(UO.ContPosX+gump[2].cx,UO.ContPosY+gump[2].cy)==gump[2].c then err=false break 
    end
end
if err then
   print(UO.GetPix(UO.ContPosX+gump[2].cx,UO.ContPosY+gump[2].cy).."x"..gump[2].c)
